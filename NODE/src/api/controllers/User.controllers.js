  ...
  try {
    ...
    if (userExists) {
      ...
      transporter.sendMail(mailOptions, (error, info) => {
        if (error) {
          console.log(error);
          return res.status(404).json({ //Lo mas correcto teoricamente seria poner el 404 pero ira mal en el futuro habra que poner 200
            resend: false,
          });
        } else {
          console.log("Email sent: " + info.response);
...
module.exports = { registerLargo, register, sendCode, registerWithRedirect, login, resendCode, checkNewUser, autoLogin, changePassword, sendPassword, modifyPassword, update, deleteUser };